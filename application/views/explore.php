    ...
    for (i = 0; i < locations.length; i++) { 
        ...
        google.maps.event.addListener(marker, 'click', (function(marker, i) {
            return function() {
                ...
                document.getElementById('pointInformation').innerHTML = document.getElementById('pointInformation').innerHTML + '<p>' + locations[i][3] + '</p>';

                if (locations[i][5] == 'confirmed') {
                    document.getElementById('pointInformation').innerHTML = document.getElementById('pointInformation').innerHTML;

                    if (sessionid>0) {
                        document.getElementById('pointInformation').innerHTML = document.getElementById('pointInformation').innerHTML + '<p>Your Rating: ' + locations[i][7] + '</p>';
                        ...
                        document.getElementById('pointInformation').innerHTML = document.getElementById('pointInformation').innerHTML + ratingsystem;
